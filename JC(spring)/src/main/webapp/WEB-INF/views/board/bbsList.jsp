		...
		<div class="row">
         ...
         %>
			<tr>
				...
				<%} %>
			<tr><td align="right" colspan="5" ><input type="text" id = "search"  name ="search"  class="form-control" style="width: 150px;" ></td><td><input type="button" value="검색" id="srbtn" name="srbtn" 	class="btn btn-primary"></td></tr>
