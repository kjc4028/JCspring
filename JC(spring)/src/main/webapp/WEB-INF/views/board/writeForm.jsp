...
<%@include file="../include/menubar.jsp"%>
	<div class="contaniner">
		<div class="row">
			<form name="f" method="post" action="${pageContext.request.contextPath}/board/bbsInsert">
			
			<%if(snum == null){ %>
				<input type="hidden" name="re_step" value="0"> 
				<input type="hidden" name="re_level" value="new">
				<input type="hidden" name="re_renum" value="0">
				
				<%}else if(snum != null){ %>
				<input type="hidden" name="re_step" value="${ccc.re_step}"> 
				<input type="hidden" name="re_level" value="${ccc.re_level}">
				<input type="hidden" name="re_renum" value="${ccc.re_renum}">
